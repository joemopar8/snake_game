...
const gridSize = 20;            //* Max grid size!
...
let gameSpeedDelay = 200;       //* Game speed delay!
...
//* Start game function :
function startGame() {
  gameStarted = true;    //* Keep track of game status! 
